package com.soumaya.produits.service;
...
@Override
public List<Produit> findByClient(Client client) {
	{
		return produitRepository.findByClient(client);
	}
}
@Override
public List<Produit> findByClientIdCl(Long id) {
	return produitRepository.findByClientIdCl(id);
}
@Override
